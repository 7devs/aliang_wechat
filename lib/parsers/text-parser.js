module.exports = function(content, echo) {
        var getVerses = require('../bible/getverses'),
            getBookInfo = require('../tools/getBookInfo.js');
        var isbn = require('../tools/isbn.js'),
            bibleRef = require('../bible/lib/bibleref.js'),
            len = content.length;

        if (len >= 13 && isbn.isISBN(content.substring(len - 13, len))) {
            getBookInfo.getBookInfo(content.substring(len - 13, len), function(err, txt) {
                echo(txt);
            });
        } else if (bibleRef.isRef(content)) {
            getVerses.getVerses(content, function(err, txt) {
                echo(txt);
            });
        } else {
            echo(content);
        ...
        //     }
        // } else {
        //     // var getBookInfo=require('../tools/getBookInfo');
        //     // getBookInfo.getBookInfo('9787550270701',function(err,info){
        //     //   reContent=info;
        //     // });
        //     reContent=content;
        // }
